...
<body>
	<div class="container-fluid">
		<!-- 上 -->
		<div class="row">
			<div class="col-md-12" style="height: 50px;background-color: #000000;">
		...
		<div class="row" style="margin-top: 10px;">
			...
			<div class="col-md-2">
				<ul class="list-group text-center" style="width:150px;float: right;margin-right: 50px;">
				  	<li class="list-group-item ${art.hot==1?'active':''}"><a href="index.do" class="channel">热门</a></li>
					<c:forEach items="${channels}" var="ch">
				  		<li class="list-group-item ${art.ch.id==ch.id?'active':''}"><a href="index.do?ch.id=${ch.id}" class="channel">${ch.name}</a></li>
					</c:forEach>
				</ul>
			</div>
			<!-- 中 -->
				...
				<c:if test="${!empty art.ch && art.ch.id!=0}">
					<div class="subchannel">
						<ul class="sub-list" style="width:660px;">
							<li class="sub-item ${art.ca==null?'sub-selected':''}"><a href="index.do?ch.id=${art.ch.id}">全部</a></li>
